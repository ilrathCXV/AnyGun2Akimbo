local BeAkimbo_WeaponFactoryManager_get_part_desc_by_part_id_from_weapon = WeaponFactoryManager.get_part_desc_by_part_id_from_weapon

function WeaponFactoryManager:get_part_desc_by_part_id_from_weapon(part_id, factory_id, blueprint)
	return BeAkimbo_WeaponFactoryManager_get_part_desc_by_part_id_from_weapon(self, part_id, factory_id:gsub("_beakimbo", ""), blueprint)
end
